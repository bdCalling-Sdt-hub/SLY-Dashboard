...
import UploadProducts from "../page/UploadProducts/UploadProducts";
import UploadProductsAdd from "../page/UploadProducts/UploadProductsAdd";
import UploadProductsEdit from "../page/UploadProducts/UploadProductsEdit";
import Orders from "../page/Orders/Orders";
import AllFaqUserAgeement from "../page/Faq/AllFaqUserAgeement";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "upload-products/add",
        element: <UploadProductsAdd />,
      },
      {
        path: "upload-products/:id",
        element: <UploadProductsEdit />,
      },
      ...
      {
        path: "settings/user-agreement/edit",
        element: <AllFaqUserAgeement />,
      },
      {
