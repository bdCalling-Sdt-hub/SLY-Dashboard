        ...
        <section className="w-full h-full min-h-screen ">
            ...
            <div className="flex justify-between items-center py-5">
                <Link to="/settings" className="flex gap-4 items-center">
                    ...
                    <h1 className="text-2xl font-semibold">Edit User Ageement</h1>
                </Link>
            </div>
            ...
            <div className="w-full p-6 rounded-lg shadow-md">
                <Form form={form} layout="vertical" onFinish={handleSubmit}>
                    ...
                    <div className="w-full flex justify-end mt-20 md:mt-16">
                        <button
                            type="submit"
                            className="bg-[#0076b5] text-white text-xl gap-2 py-2 px-8 rounded-md font-bold"
                            disabled={isLoading}
                        >
...
export default AllFaqUserAgeement;
